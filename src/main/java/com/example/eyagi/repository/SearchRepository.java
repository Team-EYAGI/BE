...
public class SearchRepository {
    ...
    //책검색
     public List<Books>searchBooks(String search){
         return em.createQuery("select b from Books b where b.title like :title",Books.class)
                 .setParameter("title", "%"+search+"%")
//                 .setParameter("author", "%"+search+"%")
                 .getResultList();
     }
    public List<Books>searchAuthor(String search){
        return em.createQuery("select b from Books b where b.author like :author",Books.class)
                .setParameter("author", "%"+search+"%")
                .getResultList();
    }
     //판매자 검색
